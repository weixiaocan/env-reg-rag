"""Run the Qdrant dense approximate-query path against Golden Set v1."""
...
OUTPUT_PATH = ROOT / "data" / "eval_results" / "m3-qdrant-bge-ann-v1.json"
COLLECTION_NAME = "m3_retrieval_v1_bge_ann"
...
def main() -> None:
    ...
    report["artifact"] = {
        "artifact_id": "m3-qdrant-bge-ann-v1",
        ...
        "runtime": {
            ...
            "qdrant_mode": "self_hosted_docker_approximate_query",
        },
        "limitations": [
            "Only 58 vectors are indexed; Qdrant may select a full scan for a collection this small.",
            "This run validates the approximate query contract and recall, not large-scale HNSW latency.",
